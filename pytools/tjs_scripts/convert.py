...
class ConversionArguments:
    ...
    no_post_process: bool = field(
        default=False,
        metadata={
            "help": "Skip optimum's ONNX export post-processing (e.g. decoder merge). "
            "Needed for models whose fp32 graph exceeds protobuf's 2GiB serialize limit."
        }
    )
...
def main():
    ...
    export_kwargs = dict(
        ...
        no_post_process=conv_args.no_post_process,
        **core_export_kwargs,
    )
